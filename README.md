...
- [CycloneDX/cyclonedx-node-npm](https://github.com/CycloneDX/cyclonedx-node-npm) ([v1.17.0](https://github.com/CycloneDX/cyclonedx-node-npm/releases/tag/v1.17.0), 5 days ago) - Create CycloneDX Software Bill of Materials (SBOM) from Node.js NPM projects. 
